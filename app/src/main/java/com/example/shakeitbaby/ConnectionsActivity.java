...
public abstract class ConnectionsActivity extends ComponentActivity {

  /**
   * These permissions are required before connecting to Nearby Connections.
   */
  private static final String[] REQUIRED_PERMISSIONS;
  private static final String TAG = "ConnectionActivity_TAG";
  ...
  protected void acceptConnection(final Endpoint endpoint, @Nullable  OnAcceptListener onSuccess) {
    mConnectionsClient
